...
class IntegrationTestCommand:
    def execute(self, ctxt: RunContext) -> None:
        ...
        meta_options = self.create_training_meta_options()
        ...
        #     max_batch_size=128,
        # )
        # ctxt.logger.report_message(f"Max Batch Size: {max_batch_size}")
    ...
    def create_run_config(
        ...
        training_length: TrainingLength = TrainingLength(use_steps=False, max_epochs=0.05)
